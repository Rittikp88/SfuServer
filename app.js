...
const io = new Server(httpServer, { cors: { origin: "*" } ,path:'/signal'}); //setting socket server which returns io .io on
// which events like on,emit are performed`
const port = process.env.PORT;



app.get("/signal", (req, res, next) => {
  res.send("<h4>Hello your server is active!</h4>");
});
